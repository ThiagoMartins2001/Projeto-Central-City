...
local tattooShops = {
    [1] = { coords = vec3(1321.77,-1654.56,52.27), h = 35.24, perm = nil },
    [2] = { coords = vec3(-1155.2,-1427.98,4.95), h = 33.89 },
    [3] = { coords = vec3(325.06,180.81,103.59), h = 151.48 },
    [4] = { coords = vec3(-3170.2,1078.08,20.83), h = 246.71 },
    [5] = { coords = vec3(1865.58,3746.7,33.03), h = 296.08 },
    [6] = { coords = vec3(-295.14,6200.63,31.49), h = 144.56 },
	[7] = { coords = vec3(1881.93,6408.16,76.55), h = 274.97 }, 
	[8] = { coords = vec3(1913.42,6435.09,76.43), h = 161.58 },
	[9] = { coords = vec3(-1814.79,30.16,94.59), h = 65.2 },
	[10] = { coords = vec3(1544.04,-749.97,118.07), h = 294.81 },
}

CreateThread(function()
	local Tables = {}
	for Number = 1,#tattooShops do
		Tables[#Tables + 1] = { tattooShops[Number]["coords"]["x"],tattooShops[Number]["coords"]["y"],tattooShops[Number]["coords"]["z"],2.0,"E","Estudio de Tattoo","Pressione para abrir" }
	end
...
function addBlips()
    for _, v in pairs(tattooShops) do
        if v.blip ~= false then
            ...
            AddTextComponentString("Loja de Tattoos")
...
function drawMarkers()
    ...
    DrawMarker(1,x,y,z-1.4,0,0,0,0,0,0,0.75,0.75,1.0,45, 80, 233,70,0,1,1,1)
end
