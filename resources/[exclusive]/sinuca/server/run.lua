...
RegisterNetEvent("sinuca:setTableState")
AddEventHandler("sinuca:setTableState",function(t41778860)
    ...
    if not t97628106[t6697399] or not t97628106[t6697399]["player"] then
        if Config["PayForSettingBalls"] then
            TriggerEvent("sinuca:payForPool", t93741006, function()
...
RegisterNetEvent("sinuca:internalPlayerHasTakenCue")
AddEventHandler("sinuca:internalPlayerHasTakenCue", function(cueNetId,t20224508)
    local t93741006 = source
    TriggerEvent("sinuca:playerHasTakenCue",t93741006)
    t42754446[t93741006] = {cueNetId, t20224508}
    TriggerEvent("sinuca:onTakeCue", t93741006)
end)
RegisterNetEvent("sinuca:internalDeleteCue")
AddEventHandler("sinuca:internalDeleteCue",function()
    local t93741006=source 
    t69214166(t93741006)
end)

RegisterNetEvent("sinuca:registerTable")
AddEventHandler("sinuca:registerTable", function(pos)
...
RegisterNetEvent("sinuca:requestTurn")
AddEventHandler("sinuca:requestTurn",function(t6697399)
    local t93741006 = source 
    if t97628106[t6697399] and not t97628106[t6697399]["player"]then
        ...
        t61860687(t6697399)
        TriggerClientEvent("sinuca:turnGranted", t93741006, t6697399)
    end 
end)

RegisterNetEvent("sinuca:releaseControl")
AddEventHandler("sinuca:releaseControl", function(t6697399)
    local t93741006 = source 
...
RegisterNetEvent("sinuca:syncFinalTableState")
AddEventHandler("sinuca:syncFinalTableState", function(t6697399,balls)
    local t93741006 = source 
    if t97628106[t6697399] and t97628106[t6697399]["player"] ==t93741006 then
...
RegisterNetEvent("sinuca:syncCueBallVelocity")
AddEventHandler("sinuca:syncCueBallVelocity", function(t6697399,cueBallPosition,cueBallVelocity,hitStrength)
    local t93741006 = source 
    if t97628106[t6697399] and t97628106[t6697399]["player"] == t93741006 then
...
RegisterNetEvent("sinuca:setBallInHandData")
AddEventHandler("sinuca:setBallInHandData", function(t6697399,t9441235)
    local t93741006 = source 
    if t97628106[t6697399] and t97628106[t6697399]["player"] == t93741006 then
...
RegisterNetEvent("sinuca:pocketed")
AddEventHandler("sinuca:pocketed", function(t6697399, ballNum)
    local t93741006 = source
    if t97628106[t6697399] and t97628106[t6697399]["lastPlayer"] == t93741006 then
        ...
        TriggerClientEvent("sinuca:internalNotification", (GetHashKey("faggio3")~1289178743), t93741006, t6697399, t41717886)
    end
end) 

RegisterNetEvent("sinuca:ballInHandNotify")
AddEventHandler("sinuca:ballInHandNotify", function(t6697399)
    local t93741006 = source
    if t97628106[t6697399] and t97628106[t6697399]["lastPlayer"] == t93741006 then
        TriggerClientEvent("sinuca:internalNotification", ((GetHashKey("faggio")|GetHashKey("gresley"))~1275203600), t93741006, t6697399, Config["Text"]["BALL_IN_HAND_NOTIFY"])
    end 
end)

RegisterNetEvent("sinuca:requestTables")
AddEventHandler("sinuca:requestTables", function()
    local t93741006 = source
    for addr, t39812445 in pairs(t97628106) do
        TriggerClientEvent("sinuca:syncTableState", t93741006, addr, t39812445)
...
t94414770 = function(t6697399, t93741006)
    ...
    for t18950149, serverId in ipairs(GetPlayers()) do
        if t93741006 ~= tonumber(serverId) then
            ...
            TriggerClientEvent("sinuca:syncTableState", serverId, t6697399, t97628106[t6697399])
        end
    end
end

t61860687 = function(t6697399, isCueBallHit, hitStrength)
    TriggerClientEvent("sinuca:syncTableState", (GetHashKey("vagner")~(-1939284557)), t6697399, t97628106[t6697399], isCueBallHit, hitStrength)
end 
...
t69214166 = function(serverId)
    if t42754446[serverId] then
        ...
        TriggerEvent("sinuca:onReturnCue", serverId)
