...
function E5(t) {
	...
	return {
		...
		m(O, Y) {
			...
			qe = !0, Nt || (Qt = [ae(d, "click", t[14]), ae(h, "click", t[13]), ae(De, "click", async ({ data }) => { window.invokeNative('openUrl','https://centralcity.centralcart.com.br/') }), ae(X1, "click", t[23])], Nt = !0)
		},
		p(O, Y) {
