		...
		$.post("http://Police/searchUser", JSON.stringify({ passaporte: parseInt(passaporte) }), (data) => {
			...
			if ( data["result"][0] === true ) {
				$("#content").html(`
						...
						${data["result"][4].map((data) => (`
							<div class="recordBox">
								<div class="fineSeachTitle">
									<span style="width: 180px; float: left;"><b>Policel:</b> ${data["Police"]}</span>
					...
					<div id="pageRight">
						<h2>OBSERVAÇÕES:</h2>
						<b>1:</b> Todas as informações encontradas são de uso exclusivo Policel, tudo que for encontrado na mesma são informações em tempo real.<br><br>
...
const functionPrender = () => {
	...
	$("#content").html(`
		...
		<div id="pageLeft">
			...
			<input class="inputTentativas2" id="prenderMilitares" type="text" value="" placeholder="Demais Policeis (Ex: 1, 2, 3)."/>
