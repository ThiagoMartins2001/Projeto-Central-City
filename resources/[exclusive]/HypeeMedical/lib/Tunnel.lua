...
function Tunnel.getInterface(name,identifier)
	...
	RegisterLocalEvent(name..":"..GetCurrentResourceName()..":tunnel_res")
	AddEventHandler(name..":"..GetCurrentResourceName()..":tunnel_res",function(rid,args)
