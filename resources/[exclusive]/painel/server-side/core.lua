    ...
    if Passport then
        ...
        if Permission == nil then
            for Key in pairs(Groups) do
                if vRP.HasPermission(Passport, Key) and Groups[Key]["Type"] and (Groups[Key]["Type"] == "Work" or Groups[Key]["Type"] == "Police" or Groups[Key]["Type"] == "Mechanic") then
                    Permission = Key
                end
            end
        end

        if Permission and vRP.HasPermission(Passport, Permission) and Groups[Permission]["Type"] and (Groups[Permission]["Type"] == "Work" or Groups[Permission]["Type"] == "Police" or Groups[Permission]["Type"] == "Mechanic") then
