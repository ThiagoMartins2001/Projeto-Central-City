...
local Beds = {
	-- Medical Center Sul
	{ ["Coords"] = vec3(329.39,-589.49,48.0), ["Heading"] = 340.58, ["Distance"] = 1.50 },
	{ ["Coords"] = vec3(320.3,-576.76,48.0), ["Heading"] = 161.58, ["Distance"] = 1.50 },
	{ ["Coords"] = vec3(317.33,-575.67,48.0), ["Heading"] = 150.58, ["Distance"] = 1.50 },
	{ ["Coords"] = vec3(323.12,-568.82,48.0), ["Heading"] = 161.58, ["Distance"] = 1.50 },
	{ ["Coords"] = vec3(319.88,-567.57,48.0), ["Heading"] = 161.58, ["Distance"] = 1.50 },
	{ ["Coords"] = vec3(316.66,-566.38,48.0), ["Heading"] = 161.58, ["Distance"] = 1.50 },
	{ ["Coords"] = vec3(315.06,-570.9,48.0), ["Heading"] = 340.58, ["Distance"] = 1.50 },
	{ ["Coords"] = vec3(318.28,-572.09,48.0), ["Heading"] = 340.58, ["Distance"] = 1.50 },
	{ ["Coords"] = vec3(311.70,-586.70,43.27), ["Heading"] = 90.0, ["Distance"] = 1.50 }, -- recepsão
	{ ["Coords"] = vec3(320.51,-585.38,48.00), ["Heading"] = 161.58, ["Distance"] = 1.50 },
	{ ["Coords"] = vec3(307.52,-571.16,38.37), ["Heading"] = 340.58, ["Distance"] = 1.50 },
	{ ["Coords"] = vec3(301.98,-560.59,38.37), ["Heading"] = 70.0, ["Distance"] = 1.50 },
...
AddEventHandler("target:PutBed",function(Number)
	if not Previous then
		...
		vRP.playAnim(false,{"switch@trevor@annoys_sunbathers","trev_annoys_sunbathers_loop_guy"},true)
...
function ThreadBeds()
	CreateThread(function()
		while Previous do			
			local Ped = PlayerPedId()
			if not IsEntityPlayingAnim(Ped,"switch@trevor@annoys_sunbathers","trev_annoys_sunbathers_loop_guy",3) or LocalPlayer["state"]["usingPhone"] then
				SetEntityCoords(Ped,Previous["x"],Previous["y"],Previous["z"] - 1,false,false,false,false)
				Previous = nil
				vRP.removeObjects()
				if Treatment then
