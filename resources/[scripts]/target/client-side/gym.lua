	...
	["Locations"] = {
		{
			...
			["Ped1"] = {
				["Price"] = 500,
				["Model"] = "u_m_y_babyd",
				["Coords"] = {-281.11,6043.13,33.07,310.54},
				["anim"] = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
			},
			["Positions"] = {
				["Bicicleta"] = {
				...
				["Abdominal"] = {
					...
					vec4(-279.85,6044.26,32.07,162.88),
				}
			}
		},	
	},
...
CreateThread(function()
    for Index, Value in pairs(Gymnasium["Locations"]) do
        -- Itera sobre os Peds dentro de cada Location
        for PedIndex, PedValue in pairs(Value) do
            if PedIndex:match("^Ped") then -- Garante que só vai iterar sobre as chaves que começam com "Ped"
                exports["creative"]:AddPed({
                    ["Distance"] = 25,
                    ["Model"] = PedValue["Model"],
                    ["Coords"] = PedValue["Coords"],
                    ["anim"] = PedValue["anim"]
                })

                exports["target"]:AddCircleZone("Gymnasium:" .. Index .. ":" .. PedIndex, vec3(PedValue["Coords"][1], PedValue["Coords"][2], PedValue["Coords"][3]), 1.0, {
                    ["name"] = "Gymnasium:" .. Index .. ":" .. PedIndex,
                }, {
                    shop = Index,
                    Distance = 0.75,
                    options = {
