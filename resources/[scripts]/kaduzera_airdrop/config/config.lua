...
Index.Main = {
    ...
    ['_reward'] = { -- recompensas do airdrop
        itens = {
            {'WEAPON_PISTOL_MK2', math.random(2, 3)},
            {'WEAPON_PISTOL_AMMO', math.random(50, 250)},
            {'dollarsroll', math.random(25000, 30000)},
            {'backpack', math.random(1, 3)},
            {'energetic', math.random(2,10)},
            {'radio', math.random(1, 3)},
            {'presente', math.random(1, 3)},
        }
    },

    ['webhook'] = { -- webhook de ganhadores
        'https://discord.com/api/webhooks/1254854151591170100/jyDKvS9w0EtuF1nbPgROjdJK41lSPETvW35u5keCc4XWE5QPGsxeUF5P9ZKopEDtePgF'
    },
