...
CreateThread(function()
	while true do
		if LocalPlayer["state"]["Active"] then
			if LocalPlayer["state"]["Policia"] or LocalPlayer["state"]["Paramedic"] or LocalPlayer["state"]["Judiciary"] or LocalPlayer["state"]["AutoExotic"]  or LocalPlayer["state"]["CentralCustoms"] or LocalPlayer["state"]["Prf"]then
