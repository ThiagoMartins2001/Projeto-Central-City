...
local List = {
	...
	{ 240.64,-898.10,30.98,"Departament",true },
	...
	{ 160.08,6651.86,31.66,"Tools",false },
	...
	{ -336.58,-245.8,34.39, "Police2",false},
	{ 1514.89,791.35,78.42, "Prf",false},
	{  2917.94,4178.91,52.5, "Prf",false},
	{ -275.47,6058.53,33.04, "Prf",false},
	{ -3019.38,386.01,16.63, "Prf",false},
	{ 217.03,-413.62,47.98, "Judiciary",false},
	...
	--{ -588.5,-1066.23,22.34,"Mralpaca",false },
	...
	{ 562.26,2741.57,42.87,"Animals",false },
	--{ 707.37,-966.89,30.41,"Weeds",false }, --ilegal
	{ 1085.83,-2001.74,31.41,"Foundry",false },
	{ 987.83,-95.28,74.85,"Drinks",false },
	--{ -1241.43,-268.67,37.77,"KoiSushi" },
	--{ -590.37, -1058.7, 22.35,"Mralpaca" },
	--{ 870.85,-2127.62,30.46,"Mechanic",false },
	{ 349.38,198.55,103.00,"Cinema" },
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- MATERIALS
-----------------------------------------------------------------------------------------------------------------------------------------
...
RegisterCommand('testLog', function(source, args)
	vRP.sendLog('testLog', '[ID] '..source..'\n[TESTOU O SISTEMA]: '..args[1]' '..os.date("\n[DATA]: %d/%m/%y [HORA]: %H:%M:%S"), true)
end)