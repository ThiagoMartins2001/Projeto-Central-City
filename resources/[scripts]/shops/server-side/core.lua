...
local List = {
	["Mechanic"] = {
		["Mode"] = "Buy",
		["List"] = {
			["1"] = { item = "advtoolbox", price = 1520, amount = 1 },
			["2"] = { item = "toolbox", price = 1000, amount = 1 },
			["3"] = { item = "tyres", price = 100, amount = 1 },
			["4"] = { item = "screwdriver", price = 100, amount = 1 },
			["5"] = { item = "WEAPON_WRENCH", price = 1200, amount = 1 },
			["6"] = { item = "pliers", price = 400, amount = 1 },
		}
	},
	["Drinks"] = {
		["Mode"] = "Buy",
	...
	["Departament"] = {
		...
		["List"] = {
            ...
            ["2"] = { item = "cannedsoup", price = 45, amount = 1 },
            ["3"] = { item = "spaghetti", price = 45, amount = 1},
            ["4"] = { item = "canofbeans", price = 45, amount = 1 },
            ["5"] = { item = "canofcorn", price = 45, amount = 1 },
            ["6"] = { item = "spoon", price = 20, amount = 1 },
            ["7"] = { item = "canopener", price = 25, amount = 1 },
            ["8"] = { item = "cigar", price = 110, amount = 1 },
            ["9"] = { item = "cigarette", price = 2, amount = 1 },
            ["10"] = { item = "ciggypack", price = 35, amount = 1 },
            ["11"] = { item = "lighter", price = 15, amount = 1 },
            ["12"] = { item = "vape", price = 320, amount = 1 },
            ["13"] = { item = "sugar", price = 25, amount = 1 },
            ["14"] = { item = "ollyrancherbag", price = 25, amount = 1 },
            ["15"] = { item = "postit", price = 10, amount = 1 },
            ["16"] = { item = "notepad", price = 15, amount = 1 },
            ["17"] = { item = "rose", price = 50, amount = 1 },
			["18"] = { item = "silk", price = 5, amount = 1 },
			["19"] = {item = "backpackp", price = 1000, amount = 1},
			["20"] = {item = "backpackm", price = 2500, amount = 1},
			["21"] = {item = "backpackg", price = 3500, amount = 1},
		}
	},
	["Fuel"] = {
		["Mode"] = "Buy",
	...
	["Pharmacy"] = {
		...
		["List"] = {
			...
			["6"] = { item = "saline", price = 30, amount = 1 },
            ["7"] = { item = "sulfuric", price = 25, amount = 1 },
            ["8"] = { item = "salitre", price = 25, amount = 1 },
			["9"] = { item = "acetone", price = 25, amount = 1 },
		}
	},
	["Paramedic"] = {
		["Mode"] = "Buy",
		...
		["List"] = {
			["2"] = { item = "adrenaline", price = 500, amount = 1 },
			["3"] = { item = "bandage", price = 65, amount = 1 },
			["4"] = { item = "gauze", price = 30, amount = 1 },
			["5"] = { item = "gdtkit", price = 60, amount = 1 },
			["6"] = { item = "medkit", price = 350, amount = 1 },
			["7"] = { item = "sinkalmy", price = 185, amount = 1 },
			["8"] = { item = "analgesic", price = 65, amount = 1 },
			["9"] = { item = "ritmoneury", price = 235, amount = 1 },
		}
	},
	["Animals"] = {
		["Mode"] = "Buy",
	...
	["Ammunation"] = {
		["Mode"] = "Buy",
		["List"] = {
			["1"] = { item = "WEAPON_SNSPISTOL", price = 8975, amount = 1 },
			["2"] = { item = "WEAPON_SNSPISTOL_MK2", price = 9975, amount = 1 },
			["3"] = { item = "WEAPON_VINTAGEPISTOL", price = 8900, amount = 1 },
			["4"] = { item = "ammo9box", price = 3575, amount = 1 },
			...
			["9"] = { item = "GADGET_PARACHUTE", price = 3500, amount = 1 },
		}
	},
	["Hamburger"] = {
		["Mode"] = "Buy",
	...
	--	["Mode"] = "Buy",
	--	["List"] = {
	--		["1"] = { item = "weedclone", price = 25, amount = 1 },
	--		["2"] = { item = "tablecoke", price = 25, amount = 1 },
	--		--["3"] = { item = "tablemeth", price = 25, amount = 1 },
	--		["4"] = { item = "tableweed", price = 25, amount = 1 },
	--		["5"] = { item = "cokeleaf", price = 25, amount = 1 },
	--		["6"] = { item = "copper", price = 25, amount = 1 },
	--		["7"] = { item = "lead", price = 50, amount = 1 },
	--		["8"] = { item = "sheetmetal", price = 50, amount = 1 },
	--		["9"] = { item = "gunpowder", price = 50, amount = 1 },
	--	}
	--},
	["Criminal4"] = {
		["Mode"] = "Sell",
	...
	["Tools"] = {
		["Mode"] = "Buy",
		["List"] = {
			["1"] = { item = "pickaxe", price = 625, amount = 1 },
			["2"] = { item = "WEAPON_WRENCH", price = 120, amount = 1 },
			["3"] = { item = "repairkit01", price = 725, amount = 1 },
			["4"] = { item = "repairkit02", price = 1625, amount = 1 },
			["5"] = { item = "toolbox", price = 2630, amount = 1 },
			["6"] = { item = "drillbit", price = 15, amount = 1 },
			["7"] = { item = "rope", price = 425, amount = 1 },
			["8"] = { item = "jackham", price = 3450, amount = 1 },
			["9"] = { item = "glassbottle", price = 30, amount = 1 },
			["10"] = { item = "plasticbottle", price = 15, amount = 1 },
			["11"] = { item = "tyres", price = 565, amount = 1 },
			["12"] = { item = "lockcore", price = 375, amount = 1 },
			["13"] = { item = "screwdriver", price = 175, amount = 1 },
			["14"] = { item = "firecracker", price = 50, amount = 1 },
			["15"] = { item = "WEAPON_HAMMER", price = 65, amount = 1 },
			["16"] = { item = "WEAPON_HATCHET", price = 130, amount = 1 },
			["17"] = { item = "WEAPON_STONE_HATCHET", price = 30, amount = 1 },
			["18"] = { item = "WEAPON_MACHETE", price = 30, amount = 1 },
			["19"] = { item = "WEAPON_FLASHLIGHT", price = 65, amount = 1 },
			["20"] = { item = "WEAPON_BATTLEAXE", price = 350, amount = 1 },
			["21"] = { item = "WEAPON_BRICK", price = 60, amount = 1 },
			["22"] = { item = "miningpan", price = 480, amount = 1 },
			["23"] = { item = "sieve", price = 250, amount = 1 },
			["24"] = { item = "WEAPON_CROWBAR", price = 120, amount = 1 },
		}
	},
	["Criminal3"] = {
		["Mode"] = "Sell",
	...
	["Digital"] = {
		["Mode"] = "Buy",
		["List"] = {
			["1"] = { item = "binoculars", price = 490, amount = 1 },
            ["2"] = { item = "camera", price = 485, amount = 1 },
            ["3"] = { item = "camera2", price = 355, amount = 1 },
            ["4"] = { item = "cellphone", price = 2350, amount = 1 },
            ["5"] = { item = "radio", price = 1150, amount = 1 },
            ["6"] = { item = "nintendo", price = 2500, amount = 1 },
            ["7"] = { item = "skateboard", price = 350, amount = 1 },
            ["8"] = { item = "paymentterminal", price = 1380, amount = 1 },
	...
	["Police"] = {
		...
		["Permission"] = "Police",
		["List"] = {
			["1"] = { item = "WEAPON_CARBINERIFLE", price = 2500, amount = 1 },
			["2"] = { item = "WEAPON_CARBINERIFLE_MK2", price = 2900, amount = 1 },
			["3"] = { item = "WEAPON_FNFAL", price = 3500, amount = 1 },
			["4"] = { item = "WEAPON_SCARH", price = 3800, amount = 1 },
			["5"] = { item = "WEAPON_HK416", price = 3800, amount = 1 },
			["6"] = { item = "WEAPON_SMG", price = 2100, amount = 1 },
			["7"] = { item = "WEAPON_PUMPSHOTGUN_MK2", price = 3800, amount = 1 },
			["8"] = { item = "WEAPON_COMBATPISTOL", price = 2000, amount = 1 },
			["9"] = { item = "WEAPON_STUNGUN", price = 1600, amount = 1 },
			["10"] = { item = "WEAPON_GLOCK22", price = 2300, amount = 1 },
			["11"] = { item = "AMMO_9", price = 30, amount = 1 },
			["12"] = { item = "AMMO_45", price = 35, amount = 1 },
			["13"] = { item = "AMMO_556", price = 50, amount = 1 },
			["14"] = { item = "AMMO_12", price = 50, amount = 1 },
			["15"] = { item = "vest", price = 500, amount = 1 },
			["16"] = { item = "gsrkit", price = 60, amount = 1 },
			["17"] = { item = "handcuff", price = 30, amount = 1 },
			["18"] = { item = "gdtkit", price = 60, amount = 1 },
			["19"] = { item = "WEAPON_SMOKEGRENADE", price = 100, amount = 1 },
			["20"] = { item = "barrier", price = 100, amount = 1 },
			["21"] = { item = "radio", price = 1150, amount = 1 },
			["22"] = { item = "WEAPON_NIGHTSTICK", price = 25, amount = 1 },
			["23"] = { item = "drone", price = 9000, amount = 1 },
            ["24"] = { item = "dronecontrol", price = 1000, amount = 1 },
			--["00"] = { item = "megaphone", price = 525, amount = 1 },
			--["00"] = { item = "ATTACH_FLASHLIGHT", price = 50, amount = 1 },
			--["00"] = { item = "ATTACH_CROSSHAIR", price = 50, amount = 1 },
			--["00"] = { item = "ATTACH_SILENCER", price = 50, amount = 1 },
			--["00"] = { item = "ATTACH_MAGAZINE", price = 50, amount = 1 },
			--["00"] = { item = "ATTACH_GRIP", price = 50, amount = 1 },
		}
	},
	["Prf"] = {
		["Mode"] = "Buy",
	...
	["Police2"] = {
		...
		["Permission"] = "Police",
		["List"] = {
			["1"] = { item = "weaponlicense", price = 20000, amount = 1 },
		}
	},
	["Judiciary"] = {
		["Mode"] = "Buy",
		["Permission"] = "Judiciary",
		["List"] = {
			["1"] = { item = "weaponlicense", price = 20000, amount = 1 },
			["2"] = { item = "namechange", price = 20000, amount = 1},
			["3"] = { item = "badge04", price = 1200, amount = 1},
		}
	},
	["Hunting2"] = {
		["Mode"] = "Buy",
	...
	["Soda"] = {
		["Mode"] = "Buy",
		["List"] = {
			["1"] = { item = "cola", price = 30, amount = 1 },
			["2"] = { item = "soda", price = 30, amount = 1 },
		}
	},
	["Hotdog"] = {
		["Mode"] = "Buy",
		["List"] = {
			["1"] = { item = "hotdog", price = 20, amount = 1 },
		}
	},
	["Recycle"] = {
		["Mode"] = "Sell",
	...
	["Fishing2"] = {
		["Mode"] = "Buy",
		["List"] = {
			["1"] = { item = "fishingrod", price = 250, amount = 1 },
			["2"] = { item = "scuba", price = 300, amount = 1 },
			["3"] = { item = "bait", price = 15, amount = 1 },
		}
	},
	["Criminal"] = {
		["Mode"] = "Sell",
	...
	["Clothes"] = {
		...
		["List"] = {
			...
			["4"] = { item = "suitcase", price = 700, amount = 1 },
			["5"] = { item = "wallet", price = 100, amount = 1 },
		}
	},
	["Materials"] = {
		["Mode"] = "Buy",
	...
	["KoiSushi"] = {
		...
		["Permission"] = "KoiSushi",
		["List"] = {
			["1"] = { item = "tayaki", price = 30, amount = 1 },
            ["2"] = { item = "ramen", price = 45, amount = 1 },
            ["3"] = { item = "onigiri", price = 45, amount = 1},
            ["4"] = { item = "bento", price = 45, amount = 1 },
            ["5"] = { item = "tempura", price = 45, amount = 1 },
            ["6"] = { item = "temaki", price = 20, amount = 1 },
            ["7"] = { item = "barcadesushi", price = 25, amount = 1 },
            ["8"] = { item = "sakiikapicante", price = 110, amount = 1 },
            ["9"] = { item = "ichigomilk", price = 2, amount = 1 },
            ["10"] = { item = "juicypeach", price = 35, amount = 1 },
            ["11"] = { item = "narutokoi", price = 15, amount = 1 },
            ["12"] = { item = "rilakkumacake", price = 320, amount = 1 },
            ["13"] = { item = "docedefeijao", price = 25, amount = 1 },
            ["14"] = { item = "saque", price = 25, amount = 1 },
            ["15"] = { item = "salmonroe", price = 10, amount = 1 },
            ["16"] = { item = "kashipan", price = 15, amount = 1 },
            ["17"] = { item = "guaranajapones", price = 50, amount = 1 },
			["18"] = { item = "biscoitoskoi", price = 5, amount = 1 },
			["19"] = {item = "biscoitodasorte", price = 1000, amount = 1},
			["20"] = {item = "boxkoisushi", price = 2500, amount = 1},
			["21"] = {item = "energeticoalpaca", price = 3500, amount = 1},
			["22"] = {item = "energetico", price = 3500, amount = 1},
		}
	},
	["Mralpaca"] = {
		["Mode"] = "Buy",
		["Permission"] = "Mralpaca",
		["List"] = {
			["1"] = { item = "batidodefruta", price = 30, amount = 1 },
            ["2"] = { item = "brownie", price = 45, amount = 1 },
            ["3"] = { item = "frapuccino", price = 45, amount = 1},
            ["4"] = { item = "alpacashake", price = 45, amount = 1 },
            ["5"] = { item = "mochacafe", price = 45, amount = 1 },
            ["6"] = { item = "alpacamelows", price = 20, amount = 1 },
            ["7"] = { item = "tortaletedemorango", price = 25, amount = 1 },
            ["8"] = { item = "acaifrutas", price = 110, amount = 1 },
            ["9"] = { item = "alpacatea", price = 2, amount = 1 },
            ["10"] = { item = "pudim", price = 35, amount = 1 },
            ["11"] = { item = "angelicecream", price = 15, amount = 1 },
            ["12"] = { item = "icecreampanda", price = 320, amount = 1 },
            ["13"] = { item = "sorveteunicornio", price = 25, amount = 1 },
            ["14"] = { item = "macaroons", price = 25, amount = 1 },
            ["15"] = { item = "milkbear", price = 10, amount = 1 },
            ["16"] = { item = "sorvetecheesecake", price = 15, amount = 1 },
            ["17"] = { item = "boxmralpaca", price = 50, amount = 1 },
			["18"] = { item = "energeticoalpaca", price = 5, amount = 1 },
			["19"] = {item = "energetico", price = 1000, amount = 1},
		}
	},
	["Cinema"] = {
		["Mode"] = "Buy",
		["Permission"] = "Cinema",
		["List"] = {
			["1"] = { item = "cola", price = 10, amount = 1 },
            ["2"] = { item = "soda", price = 10, amount = 1 },
            ["3"] = { item = "energetic", price = 15, amount = 1},
		}
	},
