...
RegisterNetEvent("trocar:ped")
AddEventHandler("trocar:ped", function(pedName)
...
RegisterNetEvent("resetar:skin")
AddEventHandler("resetar:skin", function()
    local defaultModel = GetHashKey("mp_m_freemode_01") -- ou "mp_f_freemode_01" para mulher
    ...
    -- Se usar ESX ou QB-Core
    TriggerEvent("esx_skin:resetSkin") -- ESX
    TriggerEvent("qb-clothing:loadPlayerSkin") -- QB-Core
end)
