...
RCCar.HandleKeys = function(distanceCheck)
	...
	if distanceCheck < 100.0 then
		...
		CreateThread(function()
			...
			SetEntityInvincible(RCCar.Entity, false)
...
RCCar.Spawn = function()
	...
	AttachEntityToEntity(RCCar.Skate, RCCar.Entity, GetPedBoneIndex(PlayerPedId(), 28422), 0.0, 0.0, -0.40, 0.0, 0.0,
		90.0, false, true, true, true, 1, true)
...
RCCar.Attach = function(param)
	...
	if param == 'place' then
		-- Place longboard
		AttachEntityToEntity(RCCar.Entity, PlayerPedId(), GetPedBoneIndex(PlayerPedId(), 28422), -0.1, 0.0, -0.2, 70.0,
			0.0, 270.0, 1, 1, 0, 0, 2, 1)
