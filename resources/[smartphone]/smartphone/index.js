...
var to = {
    ...
    async uploadVideo(e$) {
        ...
        let e8 = await fetch("http://89.213.5.181/smartphone/storage/upload.v2.php", {
                method: "POST",
                body: e0
            }),
            e2 = await e8.json();
...
const Xm = gm((e$, e0, e8, e2, e3, e1) => {
    ...
    return wl(), _l("div", vm, [e2.android ? (wl(), _l(e5, {
        ...
        src: "http://89.213.5.181/apps/maps.jpg",
        alt: ""
...
const gg = {
    profile: Ze(So.localhost ? {
        ...
        verified: 1,
        avatarURL: "http://89.213.5.181/apps/0af557b7-83c5-4c8d-894e-30a0d224df21.jpg"
    } : {}),
    stories: rt([]),
    storiesSeen: {},
    addStory(e$) {
        ...
        setup() {
            let e$ = So.settings.isAndroid,
                ...
                e8 = Ze(So.localhost ? [{
                    ...
                    description: "N\xe3o foi encontrado nenhum pinto no local, a Police informou que est\xe1 atr\xe1s de quem possa ter causado este incidente...",
